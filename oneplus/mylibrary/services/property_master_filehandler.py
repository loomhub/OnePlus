...
class propertyMasterFileHandler(myFileHandler):
    ...
    def extract_data_from_file(self) -> propertyMastersListDTO:
        ...
        #future_date = pd.Timestamp(datetime.now().year + 10, 12, 31)
        #df=self.convert_columns_to_date(df, ['purchase_date','sell_date'],null_value_date=future_date)
