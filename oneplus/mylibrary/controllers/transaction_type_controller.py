...
from ..dtos.transaction_type_dto import transactionTypeQueryPrimaryKey, transactionTypeQueryUpdateFlag,transactionTypesListDTO, transactionTypesDelListDTO, transactionTypeDTO
...
async def create_or_update_data(
    ...
    resultsList,errorsList = await my_service.post_data(input_data.transactionTypes, myModel, query_params.update,myObjects)
    if errorsList:
         return errorsList
    else:
         return resultsList  
